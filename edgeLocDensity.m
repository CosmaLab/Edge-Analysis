...
edge_density = edge_values./edge_area; % Density is in n of Locs per nm2
...
full_density = full_values./full_area; % Density is in n of Locs per nm2
...
%%% OUTPUT
INSIDE = [inside_density_average,percLoc_inside];
EDGE = [edge_density,percLoc_edge];
FULL = [full_density];
